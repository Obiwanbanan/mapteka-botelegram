@if(!empty($choiceBot))
    ...
    <div class="chatbots__body-wrapper">
        <div class="chatbots__fields">
            ...
            <input class="input" id="name" type="text" name="name" placeholder="Name" value="{{ $choiceBot->name }}"
                   disabled>
            <input class="input" id="token" type="text" name="token" placeholder="Token" value="{{ $choiceBot->token }}"
                   disabled>
            <input class="input" id="url" type="text" name="url" placeholder="Url webhook" value="{{ $choiceBot->url }}"
                   disabled>

        </div>
        <div class="chatbots__status">
            Webhook: <span class="{{ $status }}">{{ $status }}</span>
        </div>
    </div>
