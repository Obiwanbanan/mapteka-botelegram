    ...
    <div class="container">
        <div class="major__body">
            <div class="major__menu">
                <div id="dashboard" class="major__menu-dashboard major__menu-btn">
                ...
                <form method="POST" action="{{ route('logout') }}" id="logout" class="major__menu-logout major__menu-btn">
                    @csrf
