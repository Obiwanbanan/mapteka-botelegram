<div class="major__menu">
    <a href="/dashboard" id="dashboard" class="major__menu-dashboard major__menu-btn active-menu">
    ...
    <a href="/organization" id="organizations" class="major__menu-organizations major__menu-btn">
        <div class="major__icon">
    ...
    <a href="/chat-bots" id="chatbots" class="major__menu-chat-bots major__menu-btn" >
        <div class="major__icon">
    ...
    <a href="/settings" id="settings" class="major__menu-settings major__menu-btn">
        <div class="major__icon">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="32" height="32"
                 viewBox="0 0 32 32">
                <path
